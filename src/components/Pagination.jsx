...
const Pagination = ({moviesPages, currentPage, setCurrentPage}) => {
    ...
    return (
        <div className='pagination'>
            ...
            {moviesPages.slice(currentPage > 1 ? currentPage - 2 : currentPage - 1, currentPage > 1 ? currentPage + 1 : currentPage + 2).map(page =>
                <button
                    key={page}
